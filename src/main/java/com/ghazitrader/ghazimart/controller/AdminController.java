            ...
            if (CommanUtil.isTokenValid(standardRequest.getToken())) {
                if (CommanUtil.isNotEmptyOrNotNull(standardRequest.getActionName())) {
                    switch (standardRequest.getActionName()) {
                        ...
                        case ActionName.CATEGORIES_ITEMS:
                            return validationUtil.catProdustList(standardRequest.getData());
                        case ActionName.UPDATE_ORDER_STATUS:
                            return validationUtil.updateOrderStatus(standardRequest.getData());
